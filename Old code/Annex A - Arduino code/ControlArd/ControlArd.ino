// March 6th - This code only implements the firmata and the steering together
...
// * GLOBAL FIRMATA VARIABLES

/*
pin 51: Horn (digital high/low)
pin 50: Ignition Dash Board Miscroswitch (digital high/low)
pin 49: Reverse position Dash Board Miscroswitch (digital high/low)
pin 48: Forward position Dash Board Miscroswitch (digital high/low)
pin 11: steering value (angle) (pwm0-255)
pin 12: Brake Value (pwm 0-255)
pin 13: Acceleration Value (pwm 0-255)
pin 53: Acceleration microswitch (digital high/low)
pin 52: Steering left/right (digital high/low)
*/
int pwm_value3 = 0; ////////////////////////////////////////////////////////////////////////////////// from J5 pin 11 (PWM)
...
Stepper myStepper(stepsPerRevolution, 37, 35, 33, 31);

// Stepper Variables
const int counts_p_rev = 1600;

/////////////////////////////////////////////////////////////////////////////////
// DESIRED WHEEL INPUTS
// Wheel Input Pins:
//INPUTS:
int WheelDirPin = 42;  // Digital input pin to determine wheel direction

// Initialize Variables
//INPUTS:
int wheelVal = 0; // Input variable for wheel position
int wheelDir = LOW; // Input variable for wheel direction
...
//Steering feedback for usability
unsigned long nowMillis=0;
unsigned long oldMillis=0;
unsigned long timeDif=0;
unsigned long sampInt=20;


///////////////////////////////////////////////////////////////////////////////////////
// PinChange Interrupts
//
//// List Interrupt Input Pins
//#define INT0 2 // 
//#define INT1 3 // 
//#define INT2 21 // EncInd
//#define INT3 20 // 
//#define INT4 19 // EncPinB
//#define INT5 18 // EncPinA
    ...
    for (pin = 0; pin < TOTAL_PINS; pin++) {
      if (IS_PIN_ANALOG(pin) && pinConfig[pin] == ANALOG) {
        ...
        if (analogInputsToReport & (1 << analogPin)) {
          //currently I have disabled feedback to Node JS
          //if (analogPin != 0 && analogPin != 1 && analogPin != 2){
            //Firmata.sendAnalog(analogPin, analogRead(analogPin));
          if (analogPin == 0){
            //Firmata.sendAnalog(analogPin, pwm_value3);
          }
        }
      }
    }
